    ...
    return (<div data-testid="movies">
        {
            ...
            <>
                <Head>
                    <title>{`${searchBar.search} - Films | MY LIBRARY`}</title>
                </Head>
...
export const getServerSideProps = async (context) => {
    ...
    if (search !== ''){
        try {
            const response = await fetch(`https://www.omdbapi.com/?apikey=898a97b5&s=${search}&type=movie`);
